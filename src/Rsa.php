...
class Rsa
{
    ...
    public static function public_encrypt($decrypted, $public_key, $padding = OPENSSL_PKCS1_PADDING)
    {
        ...
        try{
            ...
            $decrypted = str_split($decrypted, 117);
            $encrypted = '';
    ...
    public static function public_decrypt($encrypted, $public_key, $padding = OPENSSL_PKCS1_PADDING)
    {
        ...
        try{
            ...
            $encrypted = str_split(base64_decode($encrypted), 128);
            $decrypted = '';
     ...
     * @return bool|string
     */
    public static function sign($string, $private_key, $key_password='', $signature_alg = OPENSSL_ALGO_SHA1)
    {
     ...
     * @return bool
     */
    public static function verify($string, $sign, $public_key, $signature_alg = OPENSSL_ALGO_SHA1)
    {
